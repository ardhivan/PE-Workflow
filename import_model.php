...
//Script Upload File..
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        $import="INSERT into model (model_id, model_name, model_division, model_status)

		values(NULL,'$data[0]','$data[1]', '0')"; //data array sesuaikan dengan jumlah kolom pada CSV anda mulai dari “0” bukan “1”
