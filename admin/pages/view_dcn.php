...
<script>
	...
	$(function(){
		...
		$('#modal-konfirmasi').on('show.bs.modal', function (event) {
			...
			modal.find('#hapus-true').attr("href","engine_dcn.php?p=hapus&id="+id); 
		...
		$('#edit-data').on('show.bs.modal', function (event) {
			...
			modal.find('#wi').attr("value",wi);
			modal.find('#pur').attr("value",pur);
			modal.find('#iqa').attr("value",iqa);
			modal.find('#pc').attr("value",pc);
			...
			// Membuat combobox terpilih berdasarkan value yg tersimpan saat pengeditan
			modal.find('#wi option').each(function(){
				  if ($(this).val() == wi )
				    $(this).attr("selected","selected");
			});
			// Membuat combobox terpilih berdasarkan value yg tersimpan saat pengeditan
			...
			// Membuat combobox terpilih berdasarkan value yg tersimpan saat pengeditan
			modal.find('#iqa option').each(function(){
				  if ($(this).val() == iqa )
				    $(this).attr("selected","selected");
			});
			// Membuat combobox terpilih berdasarkan value yg tersimpan saat pengeditan
					...
					echo "<tr>";
						...
						?>
								...
								<a  class="btn btn-xs" href="javascript:;"
									...
									data-wi="<?php echo $row['wi_stat'] ?>"
									data-pur="<?php echo $row['pur_stat'] ?>"
									data-iqa="<?php echo $row['iqa_stat'] ?>"
									data-pc="<?php echo $row['pc_stat'] ?>"
				...
				<form id="form-data" method="post" action="engine_dcn.php?p=tambah">
					...
					<div class="modal-body">
						  ...
						  <fieldset>
							...
							<div class="form-group">
						      <label for="wistat">WI Stat</label>
						      <select name="wistat" class="form-control">
							...
							<div class="form-group">
						      <label for="purstat">Purchasing Stat</label>
						      <select name="purstat" class="form-control">
						        <option value="">Select DCN stat</option>
						        <option value="OPEN">OPEN</option>
								<option value="NO NEED">NO NEED</option>
								<option value="CLOSE">CLOSE</option>
							  ...
							  <div class="form-group">
						      <label for="iqastat">IQA Stat</label>
						      <select name="iqastat" class="form-control">
						        <option value="">Select DCN stat</option>
						        <option value="OPEN">OPEN</option>
								<option value="NO NEED">NO NEED</option>
								<option value="CLOSE">CLOSE</option>
							...
							<div class="form-group">
						      <label for="pcstat">PC Stat</label>
						      <select name="pcstat" class="form-control">
						        <option value="">Select DCN stat</option>
						        <option value="OPEN">OPEN</option>
								<option value="NO NEED">NO NEED</option>
								<option value="CLOSE">CLOSE</option>
				...
				<form id="form-data" method="post" action="engine_dcn.php?p=update">
					...
					<div class="modal-body">
						  ...
						  <fieldset>
							...
							<div class="form-group">
						      <label for="wi">WI Stat</label>
						      <select name="wi" id="wi" class="form-control">
						        <option value="">Select WI stat</option>
						        <option value="OPEN">OPEN</option>
								<option value="NO NEED">NO NEED</option>
								<option value="CLOSE">CLOSE</option>
						      </select>
							...
							<div class="form-group">
						      <label for="pur">PURCH Stat</label>
						      <select name="pur" id="pur" class="form-control">
						        <option value="">Select PURCH stat</option>
						        <option value="OPEN">OPEN</option>
								<option value="NO NEED">NO NEED</option>
								<option value="CLOSE">CLOSE</option>
						      </select>
							...
							<div class="form-group">
						      <label for="iqa">IQA Stat</label>
						      <select name="iqa" id="iqa" class="form-control">
						        <option value="">Select IQA stat</option>
						        <option value="OPEN">OPEN</option>
								<option value="NO NEED">NO NEED</option>
								<option value="CLOSE">CLOSE</option>
						      </select>
