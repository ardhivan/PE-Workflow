...
<div class="row">
			   ...
			   <div class="col-lg-12">
				...
				<tbody>
								<?php $sql = $conn->query("SELECT * FROM wi WHERE  `wi_status` LIKE  'WAITING APPROVAL'"); ?>
					...
					<div class="modal-body">
						  <fieldset>
							...
							<div class="form-group">
						      ...
						      <input type="text" name="rev" class="form-control" placeholder="Revision On TP">
						    </div>
							<div class="form-group">
						      <label for="maker">Maker</label>
						      <input type="text" name="maker" class="form-control" placeholder="Maker On TP">
						    </div>
