...
<div class="row">
               <div class="row">
			   <div class="col-lg-12">
                    <h1 class="page-header">DCN NEED Verification</h1>
                </div>
                <div class="col-lg-12">
			...
			<button class="btn btn-md pull-left" data-id='0' data-toggle="modal" data-target="#tambah-data"><span class="fa fa-plus"></span> New DCN</button> <br /><br />
				...
				<tbody>
				<?php $sql = $conn->query("SELECT * FROM dcn WHERE dcn_verifstat ='Unverified' ");
					...
					<div class="modal-body">
						 ...
						 <div class="form-group">
						  ...
						  <div class="form-group">
						      ...
						      <input type="text" name="wi_no" class="form-control" placeholder="WI Number">
						    </div>
							<div class="form-group">
