...
<div class="row">
               <div class="row">
			   <div class="col-lg-12">
                    <h1 class="page-header">DCN OPEN</h1>
                </div>
                <div class="col-lg-12">
				...
				<tbody>
							<?php $sql = $conn->query("SELECT * FROM dcn WHERE  `dcn_stat` LIKE 'OPEN'"); ?>
    ...
    case "CLOSE":
        ...
        break;
					...
					echo "<tr>";
						...
						echo "<td align='center' class='$cat_wi'><b>" . $row['wi_stat'] . "</b></td>";
						echo "<td align='center' class='$cat_pur'><b>" . $row['pur_stat'] . "</b></td>";
						echo "<td align='center' class='$cat_iqa'><b>" . $row['iqa_stat'] . "</b></td>";
						echo "<td align='center' class='$cat_pc'><b>" . $row['pc_stat'] . "</b></td>";
